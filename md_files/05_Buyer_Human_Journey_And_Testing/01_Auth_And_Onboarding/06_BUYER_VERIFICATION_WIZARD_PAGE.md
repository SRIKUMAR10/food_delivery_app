...
6. **Step 6: Welcome Rewards & Profile Setup Completion (`completionSuccess`)**: First-Order ₹100 Welcome Coupon (`WELCOME100`), Zero-Mock Firestore synchronization to `buyer_user/{uid}`, navigation to Home / CurvedNavigationBarView.
