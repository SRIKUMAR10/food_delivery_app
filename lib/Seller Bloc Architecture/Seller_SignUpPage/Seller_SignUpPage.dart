...
import '../../Repository/seller_repository.dart'; // Use SellerRepository
...
class _SellerSignUpPageState extends State<SellerSignUpPage> {
  ...
  bool _obscurePassword = true; // Changed to SellerRepository
  ...
  void _navigateToLogin() {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) =>
            const SellerLoginScreen(), // Navigate to SellerLoginScreen
      ),
    );
  }
