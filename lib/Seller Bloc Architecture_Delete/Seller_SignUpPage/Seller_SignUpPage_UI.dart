...
class SellerSignUpScreenUI extends StatelessWidget {
  ...
  const SellerSignUpScreenUI({super.key, this.repository});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SellerSignUpBloc(sellerRepository: repository),
        ...
        children: [
          ...
          _buildTextField(
            ...
            suffixIcon: IconButton(
              ...
              onPressed: () =>
                  bloc.add(const SellerSignUpPasswordVisibilityToggled()),
            ),
          ),
          const SizedBox(height: 32),
          ...
          Center(
            child: MouseRegion(
              ...
              child: GestureDetector(
                ...
                onTap: state.status == SellerSignUpStatus.loading
                    ? null
                    : _handleSignUp,
                child: Container(
                  width: double.infinity,
