...
class _HomePageState extends State<HomePage> {
  ...
  // Stream for the logged-in user's Firestore profile document.
  ...
  void initState() {
    ...
    // Set up the user profile stream only if a user is logged in.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Profile drawer attached to the end (right) side of the Scaffold.
      endDrawer: const user_profile_image(),
      body: SafeArea(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _TopBar(
                              ...
                              userProfileStream: _userProfileStream,
...
class _TopBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final avatarWidget = _ProfileAvatar(
...
class _ProductImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Image.network(kDefaultFoodImageUrl, fit: BoxFit.cover),
    );
  }
}
