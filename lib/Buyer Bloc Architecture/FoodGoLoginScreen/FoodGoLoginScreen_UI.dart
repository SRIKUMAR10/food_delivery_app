...
import '../home_Page/home_Page.dart'; // Import for FoodItem
...
class _FoodGoLoginViewState extends State<_FoodGoLoginView> {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) => SignUpPageUI(
          foodItemToAccess: widget.foodItemToAccess,
        ),
      ),
    );
  }
  ...
  // --- Shared Login Card ---
  Widget _buildLoginCard(BuildContext context, FoodGoLoginState state, {bool isDesktop = false}) {
        ...
        children: [
          ...
          Center(
            child: MouseRegion(
              ...
              child: GestureDetector(
                onTap: state.status == LoginStatus.loading ? null : _handleLogin,
                child: Container(
                  width: double.infinity,
                  height: 52,
                  decoration: BoxDecoration(
