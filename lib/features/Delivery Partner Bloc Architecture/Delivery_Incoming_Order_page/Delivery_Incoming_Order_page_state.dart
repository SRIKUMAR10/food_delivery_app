...
class DeliveryIncomingOrderState extends Equatable {
  ...
  const DeliveryIncomingOrderState({
    ...
    this.storeName = '',
    this.storeAddress = '',
    this.storeLatitude = 11.4299713,
    this.storeLongitude = 77.6759418,
    this.customerName = '',
    this.customerAddress = '',
    this.customerLatitude = 11.4555052,
    this.customerLongitude = 77.6873137,
    this.driverLatitude = 11.4555052,
    this.driverLongitude = 77.6873137,
