...
class _VoiceCallPageState extends State<VoiceCallPage> {
  ...
  Future<void> _checkPermissions() async {
    ...
    final granted = await PermissionService.requestMicrophoneOnly();
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    final String appSign = dotenv.maybeGet('ZEGO_APP_SIGN') ?? '';
            ...
            child: Column(
              ...
              children: [
                ...
                if (_permanentlyDenied)
                  ElevatedButton(
                    onPressed: () => PermissionService.requestMicrophoneOnly(),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'To use real-time voice calls, you must enter your ZegoCloud credentials in .env.',
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: 24),
                ElevatedButton(
