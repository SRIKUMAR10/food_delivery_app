...
enum _SellerAddressPickerTab { search, map }

/// Interactive Google Places & Address Search modal / dialog with
/// Draggable Map Pin Picker for the Seller (Restaurant) profile,
/// themed with the Seller red accent (Color(0xFFE52929)).
class SellerGoogleAddressSearchDialog extends StatefulWidget {
  final String addressType;
  final String currentAddress;
  final GooglePlacesService? placesService;
  final ValueChanged<AddressSelectionResult> onAddressSelected;

  const SellerGoogleAddressSearchDialog({
    super.key,
      ...
      return showDialog<AddressSelectionResult>(
        ...
        builder: (ctx) => Dialog(
          ...
          child: ConstrainedBox(
            ...
            child: SellerGoogleAddressSearchDialog(
  ...
  @override
  State<SellerGoogleAddressSearchDialog> createState() =>
      _SellerGoogleAddressSearchDialogState();
}

class _SellerGoogleAddressSearchDialogState
    extends State<SellerGoogleAddressSearchDialog>
  ...
  _SellerAddressPickerTab _activeTab = _SellerAddressPickerTab.search;
  ...
  static const Color _primaryRed = Color(0xFFE52929);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: _activeTab == _SellerAddressPickerTab.search
          ...
          children: [
            Expanded(
              child: GestureDetector(
                onTap: () {
                  setState(() {
                    _activeTab = _SellerAddressPickerTab.search;
                  });
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 8),
                  decoration: BoxDecoration(
                    color: _activeTab == _SellerAddressPickerTab.search ? Colors.white : Colors.transparent,
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: _activeTab == _SellerAddressPickerTab.search
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color: _activeTab == _SellerAddressPickerTab.search ? _primaryRed : const Color(0xFF64748B),
                      ),
            ...
            Expanded(
              child: GestureDetector(
                onTap: () {
                  setState(() {
                    _activeTab = _SellerAddressPickerTab.map;
                  });
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 8),
                  decoration: BoxDecoration(
                    color: _activeTab == _SellerAddressPickerTab.map ? Colors.white : Colors.transparent,
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: _activeTab == _SellerAddressPickerTab.map
                        ? [BoxShadow(color: Colors.black.withValues(alpha: 0.05), blurRadius: 4)]
                        : null,
                  ),
                  child: Row(
                    ...
                    children: [
                      Icon(
                        Icons.map_rounded,
                        size: 16,
                        color: _activeTab == _SellerAddressPickerTab.map ? _primaryRed : const Color(0xFF64748B),
                      ),
                      const SizedBox(width: 6),
                      Text(
                        'Pick on Map',
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            _isMapDragging
                                ? 'Pinning Location...'
                                : (_isMapGeocoding ? 'Finding Address...' : 'Restaurant location'),
                            style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600),
                          ),
                        ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _selectedGoogleAddress ?? 'Move map to select restaurant location',
                      maxLines: 2,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Door / Shop No. (Optional)',
                  hintText: 'e.g. Shop 3, First Floor',
                  isDense: true,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Fetch restaurant address using device GPS',
                    style: TextStyle(
                      fontSize: 12,
  ...
  Widget _buildRefinementSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle('Door / Shop / Landmark Details (Optional)'),
        const SizedBox(height: 10),
        TextField(
          key: const ValueKey('doorFlatInputField'),
          controller: _flatDoorController,
          decoration: InputDecoration(
            labelText: 'Door / Shop / Floor / Building No.',
            hintText: 'e.g. Shop 12, Lotus Towers',
