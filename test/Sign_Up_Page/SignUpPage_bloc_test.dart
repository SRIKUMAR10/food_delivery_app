...
import 'package:food_delivery_app/features/buyer_bloc_architecture/Sign_Up_Page/SignUpPage_Bloc.dart';
import 'package:food_delivery_app/features/buyer_bloc_architecture/Sign_Up_Page/SignUpPage_Event.dart';
import 'package:food_delivery_app/features/buyer_bloc_architecture/Sign_Up_Page/SignUpPage_State.dart';
...
void main() {
  group('SignUpBloc', () {
    ...
    test('SignUpPasswordVisibilityToggled toggles visibility', () {
      ...
      expectLater(
        signUpBloc.stream,
        emitsInOrder([const SignUpState(isPasswordObscured: false)]),
      );
    });
    ...
    test('SignUpSubmitted emits loading and then success', () async {
      ...
      when(
        () => mockUserRepository.signUp(any(), any(), any()),
