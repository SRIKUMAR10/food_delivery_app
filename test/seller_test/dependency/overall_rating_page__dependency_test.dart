...
void setupDependencyInjection() {
  ...
  getIt.registerLazySingleton<OverallRatingRepository>(() => OverallRatingRepositoryImpl(getIt()));
  getIt.registerFactory<OverallRatingBloc>(() => OverallRatingBloc(repository: getIt()));
}
