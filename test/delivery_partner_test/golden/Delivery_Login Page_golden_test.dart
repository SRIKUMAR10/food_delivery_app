...
void main() {
  ...
  group('DeliveryLoginPage Golden Tests', () {
    testWidgets('matches pixel-perfect layout snapshot on mobile', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: DeliveryLoginPage(bloc: mockBloc)),
      );
      await tester.pump();
    ...
    testWidgets('matches layout snapshot on desktop viewport', (
      WidgetTester tester,
    ) async {
