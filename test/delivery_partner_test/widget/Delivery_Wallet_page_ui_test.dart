...
void main() {
  ...
  group('DeliveryWalletPage Widget Tests', () {
    testWidgets('renders desktop dashboard sections and profile', (
      ...
      expect(find.text('My Wallet'), findsNWidgets(2));
    ...
    testWidgets('shows snackbar when add payment method tapped', (
      tester,
    ) async {
      setSize(tester, const Size(1280, 1000));
      await tester.pumpWidget(buildPage());
      ...
      await tester.ensureVisible(
        find.byKey(const Key('dp_wallet_add_payment_button')),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        find.text('Add your bank account / UPI details to continue.'),
        findsOneWidget,
      );
    });
