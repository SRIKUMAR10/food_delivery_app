...
void main() {
  ...
  group('DeliveryOrderHistoryPage Accessibility Tests', () {
    testWidgets('stat card labels meet minimum text height', (tester) async {
      setDesktopSize(tester);
      await tester.pumpWidget(buildPage());
      await tester.pump();

      final statLabel = find.text('Total Orders');
      expect(statLabel, findsOneWidget);
      final size = tester.getSize(statLabel.first);
      expect(size.height, greaterThanOrEqualTo(15.0));
    });
