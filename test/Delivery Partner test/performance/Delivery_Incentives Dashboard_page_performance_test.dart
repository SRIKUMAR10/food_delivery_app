...
void main() {
  ...
  group('DeliveryIncentivesDashboardPage Performance & Memory Tests', () {
    testWidgets('renders the incentives dashboard UI within frame threshold', (
      tester,
    ) async {
    ...
    testWidgets('disposes the page without leaks', (tester) async {
      ...
      expect(find.byType(DeliveryIncentivesDashboardPage), findsNothing);
      expect(tester.takeException(), isNull);
    });

    testWidgets('handles rapid range and filter switches without frame drops', (
      tester,
    ) async {
      setDesktopSize(tester);
    ...
    testWidgets('export action runs without frame exceptions', (tester) async {
      setDesktopSize(tester);
