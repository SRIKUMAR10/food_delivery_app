...
void main() {
  ...
  group('DeliveryOrderHistoryPage State Restoration Tests', () {
    ...
    testWidgets('preserves wallet badge and notification badge across rebuilds',
        (tester) async {
      setDesktopSize(tester);
      await tester.pumpWidget(buildPage());
      await tester.pump();
    ...
    testWidgets('preserves profile badge across widget rebuilds',
        (tester) async {
      setDesktopSize(tester);
      await tester.pumpWidget(buildPage());
      await tester.pump();
    ...
    testWidgets('preserves sidebar visibility across widget rebuilds',
        (tester) async {
      setDesktopSize(tester);
      await tester.pumpWidget(buildPage());
      await tester.pump();
