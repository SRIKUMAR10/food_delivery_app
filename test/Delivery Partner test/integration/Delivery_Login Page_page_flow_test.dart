...
void main() {
  ...
  group('Delivery Login Page Integration Flow Tests', () {
    testWidgets('successful user flow login with phone number', (WidgetTester tester) async {
      ...
      verify(() => mockRepository.loginWithPhone('9876543210', 'password123')).called(1);
