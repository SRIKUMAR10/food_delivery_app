...
void main() {
  ...
  group('DeliveryLoginPage Widget Tests', () {
    testWidgets('renders all essential UI elements properly', (WidgetTester tester) async {
      ...
      expect(find.text('Login to continue your delivery journey'), findsOneWidget);
    ...
    testWidgets('allows entering phone number and password', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1280, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      verify(() => mockBloc.add(const DeliveryLoginPhoneChangedEvent('9876543210'))).called(1);
      verify(() => mockBloc.add(const DeliveryLoginPasswordChangedEvent('mySecretPass'))).called(1);
    });

    testWidgets('toggles remember me checkbox when tapped', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1280, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      verify(() => mockBloc.add(const DeliveryLoginToggleRememberMeEvent())).called(1);
    });
  });
}
